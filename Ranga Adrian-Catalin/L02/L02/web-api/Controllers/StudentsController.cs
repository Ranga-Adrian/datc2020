...
namespace web_api.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        {
            try{
                int size = StudentRepo.Students.Count;
                StudentRepo.Students.RemoveAt(Id);
                //StudentRepo.Students.Remove(StudentRepo.Students[Id]);
                StudentRepo.Students.Capacity = --size;
                //StudentRepo.Students[Id] = StudentRepo.Students[Id-1];
        ...
        [HttpPut]
        public string Put([FromHeader]int Id, [FromBody]Student student)
        {
            try{
